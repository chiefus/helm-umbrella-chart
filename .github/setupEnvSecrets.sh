...
exportWithMask "/prod/rds/mysql/host" 'RDS_HOST'
exportWithMask "/prod/rds/mysql/username" 'RDS_USERNAME'
exportWithMask "/prod/rds/mysql/password" 'RDS_PASSWORD'
exportWithMask "/prod/rabbitmq/USERNAME" 'MQ_USERNAME'
exportWithMask "/prod/rabbitmq/PASSWORD" 'MQ_PASSWORD'
exportWithMask "/prod/psql/DB_PASSWORD" 'PSQL_PASSWORD'
...
exportWithMask "/prod/efs/file_system_id" 'EFS_FILESYSTEM_ID'
